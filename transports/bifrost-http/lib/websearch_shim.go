...
// StreamingShimMiddleware injects the noAgentBrowser instruction into
// system prompts for inference requests so agents use web_search/web_fetch
// instead of agent_browser for web lookups.
